...
export class PaymentEditAdminComponent extends AbstractEditController<PaymentDto, PaymentCriteria, PaymentService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.paidDate = this.paymentService.format(this.item.paidDate);
    }
