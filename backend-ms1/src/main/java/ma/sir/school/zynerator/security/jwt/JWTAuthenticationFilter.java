package ma.sir.school.zynerator.security.jwt;
...
import ma.sir.school.SchoolApplication;
import ma.sir.school.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = SchoolApplication.getCtx().getBean(UserService.class);
